...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @address_1 = Address.create(nickname: 'Home', name: 'Megan', street_address: '123 A Street', city: 'Dallas', state: 'TX', zip: '75070', user_id: @m_user.id)
      ...
      @order_3 = @m_user.orders.create!(status: "cancelled", address_id: @address_1.id)
