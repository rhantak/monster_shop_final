...
RSpec.describe "Admin Users Index" do
  describe "As an Admin" do
    before :each do
      ...
      @d_user = User.create(name: 'Brian', password: 'securepassword')
      @a_user = User.create(name: 'Meg', password: 'securepassword', role: 'admin')
      @admin = User.create(name: 'Sal', password: 'securepassword', role: 'admin')
