...
RSpec.describe Merchant do
  ...
  describe 'Instance Methods' do
    before :each do
      ...
      @address_1 = Address.create(nickname: 'Home', name: 'Megan', street_address: '123 A Street', city: 'Denver', state: 'CO', zip: '75070', user_id: @user_1.id)
      @address_2 = Address.create(nickname: 'Home', name: 'Megan', street_address: '123 A Street', city: 'Denver', state: 'IA', zip: '75070', user_id: @user_2.id)
      @order_1 = @user_1.orders.create!(address_id: @address_1.id)
      @order_2 = @user_2.orders.create!(status: 1, address_id: @address_2.id)
      @order_3 = @user_2.orders.create!(status: 1, address_id: @address_2.id)
